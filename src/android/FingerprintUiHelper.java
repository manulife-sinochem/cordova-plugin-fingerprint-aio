...
public class FingerprintUiHelper extends FingerprintManager.AuthenticationCallback {
    ...
    public void startListening(FingerprintManager.CryptoObject cryptoObject) {
        ...
        Log.e("Fingerprint", "startListening..authenticate...");
        mFingerprintManager
    ...
    public void onAuthenticationError(final  int errMsgId,final CharSequence errString) {
        Log.e("Fingerprint", "onAuthenticationError"+errMsgId+"-"+errString);
    ...
    public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
        Log.e("Fingerprint", "onAuthenticationError"+helpMsgId+"-"+helpString);
    ...
    public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
        Log.e("Fingerprint", "onAuthenticationSucceeded");
